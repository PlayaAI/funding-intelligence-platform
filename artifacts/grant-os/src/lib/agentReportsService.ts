...
export async function listAgentReports(filters?: AgentReportFilters): Promise<AgentReportRow[]> {
...
export async function archiveAgentReport(id: string): Promise<void> {
